import { __decorate, __extends, __assign, __values } from 'tslib';
...
var CanvasGroupMask = /** @class */ (function () {
    ...
    CanvasGroupMask.prototype.addCanvasGroupMask = function () {
        var overlays = select(this.viewer.svgOverlay().node().parentNode);
    ...
    CanvasGroupMask.prototype.getLeftMaskRect = function () {
        var imgBounds = new Rect$1(this.canvasGroupRect.x, this.canvasGroupRect.y, this.canvasGroupRect.width, this.canvasGroupRect.height);
...
var ZoomStrategy = /** @class */ (function () {
    ...
    ZoomStrategy.prototype.getDashboardViewportBounds = function () {
        ...
        var maxViewportDimensions = new Dimensions(select(this.viewer.container.parentNode.parentNode)
            .node()
        ...
        var viewportSizeInViewportCoordinates = this.viewer.viewport.deltaPointsFromPixels(new Point(viewportWidth, viewportHeight));
