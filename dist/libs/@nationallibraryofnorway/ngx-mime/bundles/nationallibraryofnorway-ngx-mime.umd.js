(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var StyleService = /** @class */ (function () {
        ...
        StyleService.ɵprov = core.ɵɵdefineInjectable({ factory: function StyleService_Factory() { return new StyleService(core.ɵɵinject(core.NgZone)); }, token: StyleService, providedIn: "root" });
    ...
    var ContentSearchDialogComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('contentSearchResult', { static: true })
        ], ContentSearchDialogComponent.prototype, "resultContainer", void 0);
        __decorate([
            core.ViewChild('query', { static: true })
        ], ContentSearchDialogComponent.prototype, "qEl", void 0);
        __decorate([
            core.ViewChildren('hitButton', { read: core.ElementRef })
    ...
    var TocComponent = /** @class */ (function () {
        function TocComponent(intl, changeDetectorRef, iiifManifestService, viewerService, canvasService) {
            ...
            this.viewerService = viewerService;
            this.canvasService = canvasService;
            this.canvasChanged = new core.EventEmitter();
            this.destroyed = new rxjs.Subject();
        }
        ...
        ContentsDialogModule = __decorate([
            core.NgModule({
                ...
                providers: [
                    ContentsDialogService,
                    ContentsDialogConfigStrategyFactory,
                    { provide: core$1.ErrorStateMatcher, useClass: core$1.ShowOnDirtyErrorStateMatcher }
                ],
    ...
    var OsdToolbarComponent = /** @class */ (function () {
        ...
        __decorate([
            core.HostBinding('@osdToolbarState')
    ...
    var ViewerFooterComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('mimeFooterBefore', { read: core.ViewContainerRef, static: true })
        ], ViewerFooterComponent.prototype, "mimeFooterBefore", void 0);
        __decorate([
            core.ViewChild('mimeFooterAfter', { read: core.ViewContainerRef, static: true })
        ], ViewerFooterComponent.prototype, "mimeFooterAfter", void 0);
        __decorate([
            core.HostBinding('@footerState')
    ...
    var ViewerHeaderComponent = /** @class */ (function () {
        ...
        __decorate([
            core.ViewChild('mimeHeaderBefore', { read: core.ViewContainerRef, static: true })
        ], ViewerHeaderComponent.prototype, "mimeHeaderBefore", void 0);
        __decorate([
            core.ViewChild('mimeHeaderAfter', { read: core.ViewContainerRef, static: true })
        ], ViewerHeaderComponent.prototype, "mimeHeaderAfter", void 0);
        __decorate([
            core.HostBinding('@headerState')
    ...
    var ViewerComponent = /** @class */ (function () {
        function ViewerComponent(snackBar, intl, el, iiifManifestService, contentsDialogService, attributionDialogService, contentSearchDialogService, helpDialogService, viewerService, mimeService, changeDetectorRef, modeService, iiifContentSearchService, accessKeysHandlerService, canvasService, viewerLayoutService, styleService, zone) {
            ...
            this.tabIndex = 0;
            this.viewerModeChanged = new core.EventEmitter();
            this.canvasChanged = new core.EventEmitter();
            this.qChanged = new core.EventEmitter();
            this.manifestChanged = new core.EventEmitter();
            this.destroyed = new rxjs.Subject();
        ...
        __decorate([
            core.ViewChild('mimeHeader', { static: true })
        ], ViewerComponent.prototype, "header", void 0);
        __decorate([
            core.ViewChild('mimeFooter', { static: true })
        ], ViewerComponent.prototype, "footer", void 0);
        __decorate([
            core.ViewChild('mimeOsdToolbar')
